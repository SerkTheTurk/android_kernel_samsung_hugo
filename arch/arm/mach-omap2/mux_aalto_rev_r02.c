/*
 * linux/arch/arm/mach-omap2/mux_aalto_rev_r02.c
 *
 ...
 */
	...
	// 303 (AF10, H, GPIO_12, LCD_ENABLE, I[H], OFF[H])
	OMAP3_MUX(ETK_CLK,	OMAP_MUX_MODE4 | OMAP_PIN_OUTPUT | OMAP_PIN_OFF_OUTPUT_LOW),
