/*
 * linux/arch/arm/mach-omap2/mux_aalto_rev_r05.c
 *
 ...
 */
	...
	OMAP3_MUX(MCBSP3_CLKX, OMAP_MUX_MODE4 | OMAP_PIN_INPUT),
...
static struct omap_board_mux aalto_r05_mux[] __initdata = {
	// 162 (AF5, L, GPIO_142, TOUCH_INT, I[L], OFF[L])
...
unsigned int aalto_r05_mux_size = ARRAY_SIZE(aalto_r05_mux);
EXPORT_SYMBOL(aalto_r05_mux_size);
struct omap_board_mux *aalto_r05_mux_ptr = aalto_r05_mux;
EXPORT_SYMBOL(aalto_r05_mux_ptr);
